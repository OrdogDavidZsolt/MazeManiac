...
namespace MazeManiac
{
    class MapHandler
    {
        ...
        private bool mapFight(Player p, Enemy e)
        {
            ...
            if (harc_log[harc_log.Count - 2] == "PLAYER")
            {
                return true;
            }
        ...
        private void move(int xmod, int ymod)
        {
            ...
            try
            {
                ...
                {
                    Random r = new Random();
                    if (r.Next(1, 101) < p.veszelyeztetettseg)
                    {
                        Hobbit o = new Hobbit();
                ...
                {
                    p.veszelyeztetettseg += 50;
                    this.message += "Beléptél a hobbiterdőbe, ezek többen vannak, mint nyáron a szúnyogok....";
                    map[x + xmod, y + ymod] = '@';
                    map[x, y] = '.';
