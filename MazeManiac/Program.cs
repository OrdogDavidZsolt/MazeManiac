        ...
        static void Main(string[] args)
        {
            ...
            while (gameIsRunning) {             
                ...
                switch (command)
                {
                    ...
                    case 'p': Console.WriteLine("A tarsolyodban ennyi érme van:"+ jatekos.tarsoly); break;
                    case 'i': Console.WriteLine("Eddig lemészárolt ellenfeleid:"+ jatekos.megolt_ellenfelek); break;
